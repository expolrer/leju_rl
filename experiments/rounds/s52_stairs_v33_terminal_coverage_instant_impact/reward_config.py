...
@configclass
class KuavoS52TerminalCoverageInstantImpactRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
...
@configclass
class KuavoS52StairsTerminalCoverageInstantImpactEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52TerminalCoverageInstantImpactRewardsCfg = (
        KuavoS52TerminalCoverageInstantImpactRewardsCfg()
    )
    ...
    def __post_init__(self):
        ...
        self.commands.motion.terrain_focus_fraction = 0.70
...
@configclass
class KuavoS52StairsTerminalCoverageInstantImpactEnvCfg_PLAY(
    KuavoS52StairsTerminalCoverageInstantImpactEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
