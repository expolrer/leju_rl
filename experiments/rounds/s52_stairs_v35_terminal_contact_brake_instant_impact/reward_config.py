...
@configclass
class KuavoS52TerminalContactBrakeInstantImpactRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
    ...
    terminal_contact_route_brake = RewTerm(
        func=local_rewards.terminal_contact_conditioned_route_brake_penalty,
        weight=-0.75,
        params={
            "command_name": "motion",
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=FEET),
...
@configclass
class KuavoS52StairsTerminalContactBrakeInstantImpactEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52TerminalContactBrakeInstantImpactRewardsCfg = (
        KuavoS52TerminalContactBrakeInstantImpactRewardsCfg()
    )
...
@configclass
class KuavoS52StairsTerminalContactBrakeInstantImpactEnvCfg_PLAY(
    KuavoS52StairsTerminalContactBrakeInstantImpactEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
