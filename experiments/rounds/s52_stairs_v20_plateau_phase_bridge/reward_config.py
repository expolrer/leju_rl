...
@configclass
class KuavoS52PlateauPhaseBridgeRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsPlateauPhaseBridgeEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52PlateauPhaseBridgeRewardsCfg = KuavoS52PlateauPhaseBridgeRewardsCfg()

    def __post_init__(self):
        super().__post_init__()

        motion_cfg = self.commands.motion
        self.commands.motion = local_commands.PlateauPhaseBridgeMotionCommandCfg(
...
@configclass
class KuavoS52StairsPlateauPhaseBridgeEnvCfg_PLAY(
    KuavoS52StairsPlateauPhaseBridgeEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
