...
@configclass
class KuavoS52DecoupledImpactTailRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
    ...
    segment_constraint_probe = RewTerm(
        func=local_rewards.broad_impact_constraint_probe,
...
@configclass
class KuavoS52StairsDecoupledImpactTailEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52DecoupledImpactTailRewardsCfg = (
        KuavoS52DecoupledImpactTailRewardsCfg()
    )
...
@configclass
class KuavoS52StairsDecoupledImpactTailEnvCfg_PLAY(
    KuavoS52StairsDecoupledImpactTailEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
