...
@configclass
class KuavoS52TerminalPredictiveTubeInstantImpactRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
    ...
    terminal_predictive_route_tube = RewTerm(
        func=local_rewards.terminal_predictive_route_tube_penalty,
        weight=-0.75,
        params={
            "command_name": "motion",
...
@configclass
class KuavoS52StairsTerminalPredictiveTubeInstantImpactEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52TerminalPredictiveTubeInstantImpactRewardsCfg = (
        KuavoS52TerminalPredictiveTubeInstantImpactRewardsCfg()
    )
...
@configclass
class KuavoS52StairsTerminalPredictiveTubeInstantImpactEnvCfg_PLAY(
    KuavoS52StairsTerminalPredictiveTubeInstantImpactEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
