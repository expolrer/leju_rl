...
@configclass
class KuavoS52TailNorm4InstantImpactRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
...
@configclass
class KuavoS52StairsTailNorm4InstantImpactEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52TailNorm4InstantImpactRewardsCfg = (
        KuavoS52TailNorm4InstantImpactRewardsCfg()
    )
...
@configclass
class KuavoS52StairsTailNorm4InstantImpactEnvCfg_PLAY(
    KuavoS52StairsTailNorm4InstantImpactEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
