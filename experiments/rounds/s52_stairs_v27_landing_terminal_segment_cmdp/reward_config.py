...
@configclass
class KuavoS52LandingTerminalSegmentConstraintRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
    ...
    segment_constraint_probe = RewTerm(
        func=local_rewards.landing_terminal_segment_constraint_probe,
...
@configclass
class KuavoS52StairsLandingTerminalSegmentConstraintEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52LandingTerminalSegmentConstraintRewardsCfg = (
        KuavoS52LandingTerminalSegmentConstraintRewardsCfg()
    )
...
@configclass
class KuavoS52StairsLandingTerminalSegmentConstraintEnvCfg_PLAY(
    KuavoS52StairsLandingTerminalSegmentConstraintEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
