...
@configclass
class KuavoS52FastPlateauBridgeRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsFastPlateauBridgeEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52FastPlateauBridgeRewardsCfg = KuavoS52FastPlateauBridgeRewardsCfg()
...
@configclass
class KuavoS52StairsFastPlateauBridgeEnvCfg_PLAY(
    KuavoS52StairsFastPlateauBridgeEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
