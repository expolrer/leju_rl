...
@configclass
class KuavoS52TerminalFocusSnapshotTrustRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsTerminalFocusSnapshotTrustEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52TerminalFocusSnapshotTrustRewardsCfg = KuavoS52TerminalFocusSnapshotTrustRewardsCfg()
...
@configclass
class KuavoS52StairsTerminalFocusSnapshotTrustEnvCfg_PLAY(
    KuavoS52StairsTerminalFocusSnapshotTrustEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
