...
@configclass
class KuavoS52PlatformHoldRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsPlatformHoldEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52PlatformHoldRewardsCfg = KuavoS52PlatformHoldRewardsCfg()
    ...
    def __post_init__(self):
        ...
        observation_params = {
            ...
            "route_gain": 0.40,
            "route_clip": 1.0,
            "hold_frame_start": 720,
            "hold_frame_end": 900,
            "hold_gain": 0.20,
        }
        self.observations.policy.motion_anchor_ori_b.func = (
            local_observations.motion_anchor_ori_route_hold_b
        )
...
@configclass
class KuavoS52StairsPlatformHoldEnvCfg_PLAY(KuavoS52StairsPlatformHoldEnvCfg):
    def __post_init__(self):
        super().__post_init__()
