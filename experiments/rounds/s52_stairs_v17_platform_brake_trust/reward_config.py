...
@configclass
class KuavoS52PlatformBrakeTrustRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsPlatformBrakeTrustEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52PlatformBrakeTrustRewardsCfg = KuavoS52PlatformBrakeTrustRewardsCfg()
...
@configclass
class KuavoS52StairsPlatformBrakeTrustEnvCfg_PLAY(
    KuavoS52StairsPlatformBrakeTrustEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
