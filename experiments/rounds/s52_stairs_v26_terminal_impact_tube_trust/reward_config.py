...
@configclass
class KuavoS52TerminalImpactTubeTrustRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
    ...
    descent_peak_contact_force = RewTerm(
        func=local_rewards.windowed_peak_contact_force_barrier,
        weight=-0.10,
        params={
            "command_name": "motion",
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=FEET),
            "force_threshold": 1400.0,
            "force_scale": 500.0,
            "max_penalty": 16.0,
            "frame_start": 600,
            "frame_end": 1340,
...
@configclass
class KuavoS52StairsTerminalImpactTubeTrustEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52TerminalImpactTubeTrustRewardsCfg = KuavoS52TerminalImpactTubeTrustRewardsCfg()
...
@configclass
class KuavoS52StairsTerminalImpactTubeTrustEnvCfg_PLAY(
    KuavoS52StairsTerminalImpactTubeTrustEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
