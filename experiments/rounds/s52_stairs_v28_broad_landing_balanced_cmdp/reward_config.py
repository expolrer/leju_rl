...
@configclass
class KuavoS52BroadLandingBalancedConstraintRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
    ...
    segment_constraint_probe = RewTerm(
        func=local_rewards.broad_landing_terminal_constraint_probe,
        ...
        params={
            ...
            "terminal_frame_start": 1260,
            "terminal_frame_end": 1340,
            "terminal_error_threshold": 0.24,
            "terminal_error_scale": 0.12,
            "terminal_cost_cap": 4.0,
        },
    )


@configclass
class KuavoS52StairsBroadLandingBalancedConstraintEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52BroadLandingBalancedConstraintRewardsCfg = (
        KuavoS52BroadLandingBalancedConstraintRewardsCfg()
    )
...
@configclass
class KuavoS52StairsBroadLandingBalancedConstraintEnvCfg_PLAY(
    KuavoS52StairsBroadLandingBalancedConstraintEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
