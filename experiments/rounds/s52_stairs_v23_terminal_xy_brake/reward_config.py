...
@configclass
class KuavoS52TerminalXYBrakeRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsTerminalXYBrakeEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52TerminalXYBrakeRewardsCfg = KuavoS52TerminalXYBrakeRewardsCfg()
...
@configclass
class KuavoS52StairsTerminalXYBrakeEnvCfg_PLAY(
    KuavoS52StairsTerminalXYBrakeEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
