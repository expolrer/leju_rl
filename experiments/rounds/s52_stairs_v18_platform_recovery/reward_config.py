...
@configclass
class KuavoS52PlatformRecoveryRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsPlatformRecoveryEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52PlatformRecoveryRewardsCfg = KuavoS52PlatformRecoveryRewardsCfg()
...
@configclass
class KuavoS52StairsPlatformRecoveryEnvCfg_PLAY(
    KuavoS52StairsPlatformRecoveryEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
