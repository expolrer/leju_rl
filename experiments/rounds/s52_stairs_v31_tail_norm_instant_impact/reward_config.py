...
@configclass
class KuavoS52TailNormInstantImpactRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
...
@configclass
class KuavoS52StairsTailNormInstantImpactEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52TailNormInstantImpactRewardsCfg = (
        KuavoS52TailNormInstantImpactRewardsCfg()
    )
...
@configclass
class KuavoS52StairsTailNormInstantImpactEnvCfg_PLAY(
    KuavoS52StairsTailNormInstantImpactEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
