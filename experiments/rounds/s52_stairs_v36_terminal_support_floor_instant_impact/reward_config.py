...
@configclass
class KuavoS52TerminalSupportFloorInstantImpactRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
...
@configclass
class KuavoS52StairsTerminalSupportFloorInstantImpactEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52TerminalSupportFloorInstantImpactRewardsCfg = (
        KuavoS52TerminalSupportFloorInstantImpactRewardsCfg()
    )
...
@configclass
class KuavoS52StairsTerminalSupportFloorInstantImpactEnvCfg_PLAY(
    KuavoS52StairsTerminalSupportFloorInstantImpactEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
