...
@configclass
class KuavoS52SegmentPeakTailNormRewardsCfg(
    KuavoS52ScheduledFootholdRewardsCfg
):
    ...
    segment_constraint_probe = RewTerm(
        func=local_rewards.segment_peak_impact_constraint_probe,
        ...
        params={
            ...
            "impact_force_threshold": 1300.0,
            "impact_force_scale": 700.0,
            "impact_cost_cap": 4.0,
            "all_course_hard_force_threshold": 1600.0,
        },
    )


@configclass
class KuavoS52StairsSegmentPeakTailNormEnvCfg(
    KuavoS52StairsScheduledFootholdEnvCfg
):
    rewards: KuavoS52SegmentPeakTailNormRewardsCfg = (
        KuavoS52SegmentPeakTailNormRewardsCfg()
    )
...
@configclass
class KuavoS52StairsSegmentPeakTailNormEnvCfg_PLAY(
    KuavoS52StairsSegmentPeakTailNormEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
