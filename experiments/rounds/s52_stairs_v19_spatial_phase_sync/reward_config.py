...
@configclass
class KuavoS52SpatialPhaseSyncRewardsCfg(KuavoS52ScheduledFootholdRewardsCfg):
...
@configclass
class KuavoS52StairsSpatialPhaseSyncEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
    rewards: KuavoS52SpatialPhaseSyncRewardsCfg = KuavoS52SpatialPhaseSyncRewardsCfg()

    def __post_init__(self):
        super().__post_init__()

        motion_cfg = self.commands.motion
        self.commands.motion = local_commands.SpatialPhaseSyncMotionCommandCfg(
            ...
            phase_sync_end_frame=1100,
            phase_sync_trigger_ahead_m=0.08,
            phase_reference_lead_m=0.03,
            phase_sync_max_advance_per_step=4,
        )
...
@configclass
class KuavoS52StairsSpatialPhaseSyncEnvCfg_PLAY(
    KuavoS52StairsSpatialPhaseSyncEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
