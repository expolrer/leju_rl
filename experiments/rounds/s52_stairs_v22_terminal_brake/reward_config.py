...
@configclass
class KuavoS52StairsTerminalBrakeEnvCfg(KuavoS52StairsScheduledFootholdEnvCfg):
...
@configclass
class KuavoS52StairsTerminalBrakeEnvCfg_PLAY(
    KuavoS52StairsTerminalBrakeEnvCfg
):
    def __post_init__(self):
        super().__post_init__()
