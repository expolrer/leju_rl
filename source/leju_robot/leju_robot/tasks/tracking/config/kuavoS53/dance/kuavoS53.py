...
KuavoS53_CYLINDER_CFG = leju.KuavoS53ArticulationCfg()

KuavoS53_ACTION_SCALE = {}
for a in KuavoS53_CYLINDER_CFG.actuators.values():
    ...
    joint_names_list = KuavoS53_CYLINDER_CFG.preserve_joint_order.joint_names or []
    ...
    for joint_name in candidate_joint_names:
        ...
        if e_val is None or s_val in (None, 0):
            continue
        KuavoS53_ACTION_SCALE[joint_name] = 0.25 * float(0.5 * e_val) / float(s_val)
